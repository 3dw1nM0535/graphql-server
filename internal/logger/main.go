...
// Event stores messages to log laterm from our standard interface
type Event struct {
	id      int
	message string
}

// StandardLogger enforces specific log message format
...
func NewLogger() *StandardLogger {
	...
	// We can tranform the errors into a JSON format e.g log SaaS tools such as splunk or logstash
...
// Declare variable to store log messages as new Events
var (
...
// MissingArg is a standard error message logger
